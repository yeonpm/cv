...
\begin{tabularx}{\linewidth}[t]{@{} X r @{}}
    ...
    1997.11.26 $\cdot$ 경희대학교 원자력공학과 (2026.02 졸업 예정) \newline \vspace{5pt}
...
\csection{EDUCATION}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
        \item \textbf{경희대학교 (Kyung Hee Univ.)} \hfill 2016.03 -- 2026.02 (졸업 예정) \\
        \textit{원자력공학과 (Nuclear Engineering)}
        \begin{itemize}[label={}, leftmargin=10pt, topsep=2pt]
             \item \small{창업 및 실무 병행으로 인한 휴학 후 복학 (2019 -- 현재)}
             \item \small{현재 1학점 수강 중이며, 주식회사 핸들 재직(정규직)과 학업 병행 중}
        \end{itemize}
