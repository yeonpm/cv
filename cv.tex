...
\csection{SUMMARY}{
    \begin{itemize}[leftmargin=*, noitemsep]
        ...
        \item 여러 프로젝트들을 할 때마다 발생하는 반복적인 작업을 개선하기위해 몇 가지 NPM 라이브러리화하여 배포하고, 주식회사 핸들에서 다양한 웹/앱 서비스를 런칭한 경험이 있습니다.
        \item Python, REST API 활용 능력과 백엔드(Firebase, Node.js)에 대한 이해를 바탕으로 폭 넓은 개발이 가능하며, 문제 해결을 위해서 다각도로 고민합니다.
        \item 새로운 기술을 항상 팔로우업 하며, 문제 해결을 위한 효율적인 코드 작성과 사용자 경험 개선에 집중합니다.
        \item 다양한 개인 사이드 프로젝트를 진행하며 기술 트렌드를 빠르게 파악하고 적용해봅니다.
    \end{itemize}
}
        ...
        \begin{itemize}[label={-}, noitemsep, topsep=2pt]
            ...
            \item \textbf{차량 이미지 합성 및 표준화 모듈 개발} (Python, Yolo Computer Vision) \hfill 2023 1Q - 2023 4Q
                \begin{itemize}[label=$\cdot$, noitemsep]
                    ...
                    \item 기존 평균 2MB의 PNG 이미지를 100KB의 WEBP 포맷으로 최적화하여 이미지 로딩 속도 개선 및 storage 비용 절감
            ...
            \item \textbf{오토허브셀카 ERP 시스템 개발} (React, TypeScript) \hfill 2024 1Q - 2025 4Q
                \begin{itemize}[label=$\cdot$, noitemsep]
                    ...
                    \item 기존에 월 구독료를 내고 사용하던 테이블 컴포넌트 라이브러리를 더욱 고성능화된 컴포넌트로 자체 개발
