...
\csection{PROJECTS}{
    ...
    \begin{itemize}[leftmargin=*, itemsep=5pt]
        ...
        \textit{YouTube 음악 공유·피드·플레이리스트 기반 취향 탐색 서비스 (\href{https://mmuni.vercel.app}{Link})}
        \begin{itemize}[label={-}, noitemsep, topsep=2pt]
            \item Next.js PWA + Flutter 네이티브 앱(iOS/Android) 풀스택 설계·개발, Supabase Auth/OAuth 및 피드·플레이리스트·프로필 API 연동
            \item 모바일 중심 반응형 UI, 라이트·다크·시스템 테마 동기화, PWA 피드 중심 진입 UX 구현
        \end{itemize}
